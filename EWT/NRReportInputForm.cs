...
namespace EWT
{
    public partial class NRReportInputForm : BaseForm
    {
        public NRReportInputForm()
        {
            InitializeComponent();
        }
        ...
        private void tsbReport_Click(object sender, EventArgs e)
        {
            ...
            report.Load(@"\\nas-a\EWT-Information\Software Report\NRReport.mrt");
            ...
            report.Dictionary.Databases.Add(new StiSqlDatabase("Connection", Utilities.Tools.GetEWTDBConnection));
            report.Show();
        }
    }
}

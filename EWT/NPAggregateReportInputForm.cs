...
namespace EWT
{
    public partial class NPAggregateReportInputForm : BaseForm
    {
        public NPAggregateReportInputForm()
        {
            InitializeComponent();
        }
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            report.Load(@"\\nas-a\EWT-Information\Software Report\NPAggregateReport.mrt");
            ...
            report.Compile();
            report["reptitle"] = " گزارش تجمیعی NP واحد" + departmentDataPicker.SelectedTitle;
        ...
        private async void NPAggregateReportInputForm_Load(object sender, EventArgs e)
        {

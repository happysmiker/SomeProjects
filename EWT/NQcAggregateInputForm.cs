...
namespace EWT
{
    public partial class NQcAggregateReportInputForm : BaseForm
    {
        public NQcAggregateReportInputForm()
        {
            InitializeComponent();
        }
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            report.Load(@"\\nas-a\EWT-Information\Software Report\NQcAggregateReport.mrt");
            report["@DepartmentIndex_Id"] = departmentDataPicker.SelectedId;
            report["@FromDate"] = txtFromDate.Text;
            report["@ToDate"] = txtToDate.Text;
            report.Compile();
            report["reptitle"] = " گزارش تجمیعی NQc واحد" + departmentDataPicker.SelectedTitle;
            report["dateBetween"] = txtFromDate.Text + " تا " + txtToDate.Text;

            report.Show();
        }

        private async void NQcAggregateInputForm_Load(object sender, EventArgs e)
        {

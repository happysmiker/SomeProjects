...
namespace EWT
{
    public partial class NQaAggregateReportInputForm : BaseForm
    {
        public NQaAggregateReportInputForm()
        {
            InitializeComponent();
        }
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            report.Load(@"\\nas-a\EWT-Information\Software Report\NQaAggregateReport.mrt");
            report["@DepartmentIndex_Id"] = departmentDataPicker.SelectedId;
            report["@FromDate"] = txtFromDate.Text;
            report["@ToDate"] = txtToDate.Text;
            report.Compile();
            report["reptitle"] = " گزارش تجمیعی NQA واحد" + departmentDataPicker.SelectedTitle;
            report["dateBetween"] = txtFromDate.Text + " تا " + txtToDate.Text;

            report.Show();
        }

        private async void NQaAggregateInputForm_Load(object sender, EventArgs e)
        {
